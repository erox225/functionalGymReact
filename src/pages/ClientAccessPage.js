...
const ClientAccessPage = () => {
  ...
  const clients = [
    { id: 1, nombreEstancia: 'Gimnasio', fecha: '2024-09-20', resultado: 'Aprobado', reserva: 101, clase: 'Yoga' },
    { id: 2, nombreEstancia: 'Piscina', fecha: '2024-09-22', resultado: 'Denegado', reserva: 102, clase: 'Natación' },
    { id: 3, nombreEstancia: 'Sauna', fecha: '2024-09-25', resultado: 'Aprobado', reserva: 103, clase: 'Relajación' },
  ];
